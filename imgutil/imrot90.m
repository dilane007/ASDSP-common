...
%
%   NEWI = IMROT90(I, N) rotates an intensity image I N*90 degrees anticlockwise.
%
...
%ROT90 Rotate a 3D array N*90 degrees anticlockwise.
   ...
   switch n
      case 1,  B = permute(A(:,end:-1:1,:), [2 1 3]);
      case 2,  B = A(end:-1:1,end:-1:1,:);
      case 3,  B = permute(A(end:-1:1,:,:), [2 1 3]);
   end
