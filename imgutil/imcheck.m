   ...
   switch nargsin
      ...
      case 1
         ...
         if ~any(strcmp(class(varargin{1}), valid_classes))
            msg = 'Truecolor/grayscale/bitmap: Image array is of an invalid class.';
            return
         end
         ...
         if isempty(varargin{1})
            msg = 'Truecolor/grayscale/bitmap: Image array can not be empty.';
            return
         end
         ...
         if ~islogical(varargin{1}) && isa(varargin{1}, 'double')
            ...
            if min(varargin{1}(:)) < 0
               msg = 'Truecolor/grayscale: A "double" image array can not have values < 0.';
               return
            end
         end
      ...
      case 3
         ...
         if isempty(varargin{1})
            msg = 'Old-style truecolor: All three image matrices must be non-empty.';
            return
         end
