...
//  counttrue_cimp.cpp
//
//  The C/C++ implementation of counttrue.m
//
...
mxArray* count_true(const mxArray* mxV)
{
    if (mxIsEmpty(mxV))
    {
    ...
    if (!mxIsLogical(mxV))
    {
        mexErrMsgIdAndTxt("dmtoolbox:counttrue:invalidarg", 
            "The input array to counttrue should be logical or empty");
    }
