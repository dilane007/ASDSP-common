...
% by Magnus Almgren 980930 revised 040202 by MA
...
nv = flatten(0:max(maxn(:)),newdim); % Make a ramp in that dimension.
...
% $Id: erlang.m,v 1.1 2004/02/19 17:27:42 bogdant Exp $
